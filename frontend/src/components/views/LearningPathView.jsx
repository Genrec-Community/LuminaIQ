                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                        <div>
                            ...
                            <select
                                ...
                                className="px-4 py-2 bg-[#FDF6F0] border-0 rounded-lg focus:ring-2 focus:ring-[#C8A288] text-[#4A3B32] font-medium"
                            >
                                <option value="all">All Documents ({availableTopics?.length || 0} topics)</option>
                                {selectedDocuments?.map(docId => {
                                    const topicCount = documentTopics?.[docId]?.length || 0;
                                    return (
                        ...
                        <button
                            ...
                            disabled={building}
                            className="px-6 py-3 bg-[#C8A288] text-white rounded-xl font-bold hover:bg-[#B08B72] transition-colors disabled:opacity-50 flex items-center gap-2"
                        >
                            {building ? (
                                <>
