...
const NotesView = ({ projectId, availableTopics, selectedDocuments, preSelectedTopic = null, preGeneratedData = null, onConsumePreGenerated = null, autoGenerate = false, onAutoGenerateConsumed = null }) => {
    ...
    useEffect(() => {
        if (autoGenerate && notesTopicSelection && notesTopicSelection !== '__custom__' && !autoGeneratedRef.current) {
            ...
            handleGenerateNotes();
            if (onAutoGenerateConsumed) onAutoGenerateConsumed();
        }
